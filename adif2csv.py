...
class adif2csv(object):
    ...
    def process(self, filename):
        ...
        :type all_lines_same:
        :param filename:
        :param all_lines_same: Unless you 100% know the format of your ADIF file you should put False.
        :return:
        '''
    ...
    def dump(self):
        ...
        if self.all_lines_same==True:
            ...
            for l in self.lines:
                ...
                '''
                parts= [a for a in l.split('<') if len(a) > 0]
                '''
                ...
                for p in parts:
                    ...
                    if len(pp)==2:
                        ...
                        if k in out_dict:
                            ...
                            print(str.format("Error as {} is not in output dictionary",k))
                    else:
